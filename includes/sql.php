...
/*--------------------------------------------------------------*/
 ...
 /*--------------------------------------------------------------*/
  ...
  function find_all_user(){
      global $db;
      $results = array();
      $sql = "SELECT u.id,u.name,u.mail,u.username,u.user_level,u.status,u.last_login,";
      $sql .="g.group_name ";
      $sql .="FROM users u ";
 ...
 function updateLastLogIn($user_id)
  ...
  function join_product_table(){
    ...
    $sql  .=" LEFT JOIN proveedor r ON r.id = p.provee_id";
    $sql  .=" LEFT JOIN users u ON u.id = p.name_id";
  ...
  /*--------------------------------------------------------------*/
   ...
   function find_product_by_title($product_name){
     ...
     $sql = "SELECT nameprod FROM products WHERE nameprod like '%$p_name%' LIMIT 5";
     $result = find_by_sql($sql);
     return $result;
   }
 ...
 function find_recent_product_added($limit){
   global $db;
   $sql   = " SELECT p.id,p.nameprod,p.ubicacion,p.media_id,c.namecat AS categorie,";
