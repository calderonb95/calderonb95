...
<?php
 if(isset($_POST['add_cat'])){
   ...
   if(empty($errors)){
      $sql  = "INSERT INTO categories (namecat, stock)";
      $sql .= " VALUES ('{$cat_name}', '{$cat_stock}')";
      if($db->query($sql)){
    ...
    <div class="col-md-5">
      <div class="panel panel-default">
        ...
        <input type="text" class="form-control" name="categorie-name" placeholder="Nombre de la categoría" required>
          ...
          <div class="form-group">
                <input type="text" class="form-control" name="categorie-stock" placeholder="Stock" required>
            </div>
            ...
            <tbody>
              <?php foreach ($all_categories as $cat):?>
                <tr>
                    ...
                    <td><?php echo remove_junk(ucfirst($cat['namecat'])); ?></td>
                    <td><?php echo remove_junk(ucfirst($cat['stock'])); ?></td>
